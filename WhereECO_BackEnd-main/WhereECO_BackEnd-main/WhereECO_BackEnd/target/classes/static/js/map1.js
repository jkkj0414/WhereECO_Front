...
// 마커 프린트
function printMarker(jsonData) {
    for (let i = 0; i < jsonData.length; i++) {
        var position = new kakao.maps.LatLng(jsonData[i].latitude, jsonData[i].longitude);
...
function zeroMarker(position, idx, title) {
    ...
    marker.setMap(kamap); // 지도 위에 마커를 표출합니다
